...
log_file_path = '/home/debiprasanna/ucc/src/AddressLog'
...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self):
        colNum = 0
        ColData = ["Clock","CoreID","CL","Index","Way","Tag","State","LT","PF","Touch","Lock","FillT","AccessT","AllocT","AutoInvT","Message"]
        self.setObjectName("BlockDetails")
        self.centralwidget = QtWidgets.QWidget(self)
        self.centralwidget.setObjectName("centralwidget")
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(0, 100,1850, 800))
        self.tableWidget.setObjectName("blockTableWidget")
        ...
        for col in ColData:
            ...
            item.setText(QtCore.QCoreApplication.translate("BlockDetails", ColData[colNum]))
        ...
        self.setWindowTitle(QtCore.QCoreApplication.translate("BlockDetails", "BlockDetails"))
    ...
    def loadData(self, filePath = None):
        ...
        while(True):
            ...
            blockDetails = logLine[0].split("\t")
            message = logLine[1]
            colData = np.concatenate((blockDetails,message), axis=None)
